...
//		PointF pointF0 = new PointF((mWidth-dWidth)/2, mHeight-dHeight);//起点为底部中心点
		PointF pointF0 = new PointF(random.nextInt(mWidth), mHeight-dHeight);
